...
class GuideActivity : BaseActivity() {
    ...
    companion object {
        ...
        private val DEFAULT_GUIDE_CONTENT =
            ...
            "3. 点击 \"开启拦截\"，系统会弹出 VPN 授权，点击允许。若已被其他 VPN 占用，首页会显示 VPN 共存中。\n" +
            ...
            "9. 追求更省电时，优先只开 DNS 拦截；MITM 和 Shizuku 按需开启。\n\n" +
            "二、各厂商设备专项设置\n" +
            ...
            "7. 共存诊断会显示代理本体、目标应用和共存列表状态。代理本体建议排除出寒枫 VPN，目标 App 可通过寒枫承接 TCP 后再转发到本地代理。\n" +
            "8. 如果把目标 App 完全加入白名单绕过寒枫，广告拦截能力会下降，但代理稳定性会更高。\n\n" +
            "八、规则页所有功能说明\n" +
            ...
            "7. 经常被系统中断：到系统设置里关闭电池优化、允许后台运行、锁定前台通知。详见上方各厂商设备专项设置。\n" +
            ...
            "14. 冻结后桌面图标消失：这是系统禁用应用的正常效果，到推广治理里点解冻或恢复最近治理即可找回。\n" +
            "15. 组件治理列表没有想处理的组件：使用高级手动输入，输入完整组件名后选择冻结组件或解冻组件。\n" +
            "16. 如有 BUG 或建议，可通过设置页加群入口、日志导出或现有沟通渠道继续反馈。"
